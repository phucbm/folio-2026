...
description: 'Intent-based ranking engine, 300+ card database, AI chat via MCP server (13 tools, no hallucinated data), Langfuse eval harness, 500+ Vitest test cases. Built solo.'
background: lime
variant: desktop
